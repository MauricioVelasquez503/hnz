...
<script type="text/javascript">
  function tampil_obat(input){
    ...
    $.post("modules/transaccion/medicines.php", {
      dataidobat: num,
    }, function(response) {      
      $('#stok').html(response)

      document.getElementById('cantidad_entradas').focus();
    });
  }

  function cek_jumlah_masuk(input) {
    jml = document.formObatMasuk.cantidad_entradas.value;
    var jumlah = eval(jml);
    if(jumlah < 1){
      alert('nooo !!');
  ...
  function hitung_total_stok() {
    ...
    bil2 = document.formObatMasuk.cantidad_entradas.value;
    ...
    if (bil2 == "") {
	  ...
	  var entrada = eval(bil1) + eval(bil2);
    }

	if (tt=="Salida"){
		document.formObatMasuk.total_stok.value = (salida);
	}	else {
		document.formObatMasuk.total_stok.value = (entrada);
	} 
...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=transaccion"> Entrada </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/transaccion/proses.php?act=insert" method="POST" name="formObatMasuk">
            <div class="box-body">
              <?php  
              ...
              <div class="form-group">  
                ...
                <div class="col-sm-5">
                  <select class="chosen-select" name="codigo" data-placeholder="-- Seleccionar Medicamento --" onchange="tampil_obat(this)" autocomplete="off" required>
                    <option value=""></option>
                    <?php
                      $query_obat = mysqli_query($mysqli, "SELECT codigo, nombre, id_est FROM Medicamentos where id_est = 1 ORDER BY nombre ASC")
                                                            or die('error '.mysqli_error($mysqli));
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="cantidad_entradas" name="num" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" onkeyup="hitung_total_stok(this)&cek_jumlah_masuk(this)" required>
                </div>
              </div>
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="?module=transaccion" class="btn btn-default btn-reset">Cancelar</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
