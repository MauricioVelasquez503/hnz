...
<section class="content-header">
  <h1>
    ...
    <a class="btn btn-primary btn-social pull-right" href="?module=form_transaccion&form=add" title="Agregar" data-toggle="tooltip">
  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 1) {
      ...
      echo "<div class='alert alert-danger alert-dismissable'>
              ...
              No ingresar una mayor cantidad de medicina existente.
            </div>";
    }
    ?>
