  <!-- Content Header (header de la pagina) -->
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00a65a;color:#fff" class="small-box">
          ...
          <?php  
          if ($_SESSION['permisos_acceso']!='gerente') { ?>
            <a href="?module=form_transaccion&form=add" class="small-box-footer" title="Agregar" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
          <?php
          } else { ?>
            <a class="small-box-footer"><i class="fa"></i></a>
          <?php
