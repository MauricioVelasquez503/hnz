...
if ($_SESSION['permisos_acceso']=='Super Admin') { ?>
  ...
  if ($_GET["module"]=="medicinas" || $_GET["module"]=="form_medicinas") { ?>
    <li class="active">
      <a href="?module=medicinas"><i class="fa fa-folder"></i> Datos de medicamentos </a>
      </li>
  <?php
  }
  ...
  if ($_GET["module"]=="transaccion" || $_GET["module"]=="form_transaccion") { ?>
    <li class="active">
      <a href="?module=transaccion"><i class="fa fa-clone"></i> Registro de medicamentos </a>
      </li>
  <?php
  }
